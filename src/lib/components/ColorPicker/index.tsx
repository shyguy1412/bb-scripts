...
export function ColorPicker({ initialColor, ...attr }: Props) {
    useReload();
    const [color, setColor] = useState<RGB | HSV>(
    ...
    >
        <SVCanvas
            ...
            sat={hsv.sat}
            val={hsv.val}
            setSV={(sv) => setColor({ hue: hsv.hue, ...sv })}
        >
        </SVCanvas>
        ...
        >
            ...
            <RGBDigit digitLabel='R' digit={[rgb.r, (r) => setColor({ ...rgb, r })]}>
            </RGBDigit>
            <RGBDigit digitLabel='G' digit={[rgb.g, (g) => setColor({ ...rgb, g })]}>
            </RGBDigit>
            <RGBDigit digitLabel='B' digit={[rgb.b, (b) => setColor({ ...rgb, b })]}>
            </RGBDigit>
        </span>
    </div>;
}
